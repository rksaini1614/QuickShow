...
const TrailerSection = () =>{
    ...
    console.log("url : ",currentTrailer.videoUrl);
    ...
    return (
        <div className="px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden">
            ...
            <div className="relative mt-6 rounded-b-lg">
                <BlurCircle top="-100px" right="-100px" />
                <BlurCircle bottom="-100px" left="0px" />
            ...
            <div className="group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto">

                {
                    dummyTrailers.map((trailer)=>(
                        ...
                        group-hover:not-hover:opacity-50 hover:-translate-y-1/4 duration-300
                        ...
                        onClick={()=>setCurrentTrailer(trailer)}>
                            ...
                            w-5 md:w-8 h-5 md:h-12 transform -tanslate-x-1/2 -translate-y-1/2"/>
                        </div>
                    ))
                }
            </div>
