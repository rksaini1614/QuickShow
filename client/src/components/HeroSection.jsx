...
const HeroSection = () =>{
    ...
    return (
        ...
        bg-cover bg-center h-screen">
            ...
            <img src={assets.marvelLogo} alt='bg-image' className="max-h-11 lg:h-11 mt-20"/>
            <h1 className="text-5xl md:text-[70px] md:leading-18 font-semibold">
                Guardains <br/> of the Galaxy
            </h1>
            ...
            <button className="flex item-center gap-1 px-6 py-3 text-sm bg-primary
            hover:bg-primary transition rounded-full font-medium cursor-pointer"
